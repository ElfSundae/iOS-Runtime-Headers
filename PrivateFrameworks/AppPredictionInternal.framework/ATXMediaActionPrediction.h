...
+ (id)updatePlayMediaActionPredictions:(id)arg1 withUpcomingMedia:(id)arg2 forActionKey:(id)arg3 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[389]; float x4; }*)arg4 appActionLogProbability:(double)arg5 statistics:(id)arg6;
