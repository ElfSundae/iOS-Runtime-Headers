...
@interface _ATXDESRecord : NSObject <NSSecureCoding> {
    ...
    struct { double x1[389]; double x2; } * _predictionItems;
    long long  _version;
}
...
@property (nonatomic, readonly) struct { double x1[389]; double x2; }*predictionItems;
...
- (struct { double x1[389]; double x2; }*)predictionItems;
- (long long)version;
