...
- (id)_handleStartingFingersForGesture:(id)arg1 animated:(bool)arg2 midpoint:(struct CGPoint { double x1; double x2; }*)arg3 showFingers:(bool)arg4;
...
- (void)_showFingerModels:(id)arg1 animated:(bool)arg2 startPointForAnimation:(struct CGPoint { double x1; double x2; })arg3 shouldShowPinchChain:(bool)arg4;
