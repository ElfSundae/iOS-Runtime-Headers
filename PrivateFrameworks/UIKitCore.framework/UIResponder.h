...
@property (setter=_setCopyConfiguration:, nonatomic, retain) <_UICopyConfigurationReading> *_copyConfiguration;
...
@property (nonatomic, readonly) <WFDragCoordinator> *wf_dragCoordinator;
...
- (id)_firstNonnullActivityItemsConfigurationInResponderChainForView:(id)arg1 location:(struct CGPoint { double x1; double x2; })arg2 sender:(id)arg3 responder:(id*)arg4;
- (id)_firstResponder;
...
- (id)_keyCommands;
- (id)_keyCommandsInChainPassingTest:(id /* block */)arg1 skipViewControllersPresentingModally:(bool)arg2;
- (id)_keyInput;
...
- (id)_targetCanPerformBlock:(id /* block */)arg1 nextTargetBlock:(id /* block */)arg2;
