...
@interface PXGView : UIView <PXDiagnosticsEnvironment, PXGAccessibilityRendererDelegate, PXGDiagnosticsProvider, PXGEngineDelegate, PXScrollViewControllerObserver, UIGestureRecognizerDelegate> {
