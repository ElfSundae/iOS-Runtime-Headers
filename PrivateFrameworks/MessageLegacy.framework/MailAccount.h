...
@interface MailAccount : MFAccount <EDIndexableAccount, EDReceivingAccount, EFLoggable> {
    ...
    <EFScheduler> * _mailboxCacheWriteScheduler;
...
@property (nonatomic, retain) <EFScheduler> *mailboxCacheWriteScheduler;
...
@property (nonatomic, readonly, copy) NSString *smtpIdentifier;
...
- (void)_writeMailboxCacheWithPrejudice:(bool)arg1 completionHandler:(id /* block */)arg2;
- (void)accountDidLoad;
...
- (void)setMailboxCacheWriteScheduler:(id)arg1;
