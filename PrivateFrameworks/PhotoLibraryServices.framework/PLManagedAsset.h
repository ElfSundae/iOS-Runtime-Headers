...
@interface PLManagedAsset : PLManagedObject <PLAssetDateDescriptor, PLCloudDeletable, PLDeletableManagedObject, PLMomentAssetData, PLPTPTransferableAsset, PLSyncableAsset, PLValidatesResourceModel, _PLImageLoadingAsset, _PLThumbnailLoadingAsset> {
    ...
    struct NSObject { Class x1; } * inflightImageInMemory;
    NSString * inflightImagePath;
    struct NSObject { Class x1; } * inflightIndexSheetImage;
...
- (unsigned int)RAWPlusJPEGBadgeAttribute;
...
- (void)_generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 retryNumber:(unsigned long long)arg3 completion:(id /* block */)arg4;
...
- (id)_persistedResourcesForResourceIdentity:(id)arg1 fetchConfigurationBlock:(id /* block */)arg2 error:(id*)arg3;
...
- (void)_updateDerivativesAndThumbnails:(bool)arg1 withPreviewImage:(struct NSObject { Class x1; }*)arg2 thumbnailImage:(struct NSObject { Class x1; }*)arg3 didRevertToOriginal:(bool)arg4 updateInternalResources:(bool)arg5 isSubstandardRender:(bool)arg6 isDeferred:(bool)arg7;
...
- (id)attemptReframeWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 isOnDemand:(bool)arg3 completionHandler:(id /* block */)arg4;
...
- (bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 spatialOverCaptureURL:(id)arg3 videoDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 stillDisplayTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg5 options:(unsigned long long)arg6;
- (bool)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg3 stillDisplayTime:(struct { long long x1; int x2; unsigned int x3; long long x4; })arg4 options:(unsigned long long)arg5;
...
- (void)createTHMFileWithPreviewImage:(struct NSObject { Class x1; }*)arg1 thumbnailImage:(struct NSObject { Class x1; }*)arg2;
- (id)creatorBundleID;
- (id)dateCreatedData;
...
- (id)faceRegions;
- (id)fetchResourceWithIdentity:(id)arg1 createIfNeeded:(bool)arg2 fetchConfigurationBlock:(id /* block */)arg3 error:(id*)arg4;
...
- (struct NSObject { Class x1; }*)filteredImage:(struct NSObject { Class x1; }*)arg1 withCIContext:(id)arg2;
...
- (void)generateAndUpdateThumbnailsWithPreviewImage:(struct NSObject { Class x1; }*)arg1 thumbnailImage:(struct NSObject { Class x1; }*)arg2 fromImageSource:(struct CGImageSource { }*)arg3 imageData:(id)arg4 updateExistingLargePreview:(bool)arg5 forceSRGBConversion:(bool)arg6;
- (void)generateAndUpdateThumbnailsWithPreviewImage:(struct NSObject { Class x1; }*)arg1 thumbnailImage:(struct NSObject { Class x1; }*)arg2 fromImageSource:(struct CGImageSource { }*)arg3 imageData:(id)arg4 updateExistingLargePreview:(bool)arg5 forceSRGBConversion:(bool)arg6 saveCameraPreviewWellImage:(bool)arg7;
- (void)generateDeferredAdjustmentWithImageConversionClient:(id)arg1 videoConversionClient:(id)arg2 completion:(id /* block */)arg3;
...
- (struct NSObject { Class x1; }*)imageWithFormat:(unsigned short)arg1;
- (struct NSObject { Class x1; }*)imageWithFormat:(unsigned short)arg1 outImageProperties:(const struct __CFDictionary {}**)arg2;
- (short)importedBy;
- (void)incrementUploadAttempts;
- (struct NSObject { Class x1; }*)indexSheetImage;
- (int)inferredTimeZoneOffset;
- (struct NSObject { Class x1; }*)inflightImage;
- (struct NSObject { Class x1; }*)inflightImageInMemory;
...
- (bool)isVideo;
- (unsigned int)keywordBadgeAttribute;
...
- (struct NSObject { Class x1; }*)newFullScreenImage:(const struct __CFDictionary {}**)arg1;
- (struct NSObject { Class x1; }*)newFullSizeImage;
- (struct NSObject { Class x1; }*)newLowResolutionFullScreenImage;
...
- (void)setInflightImageInMemory:(struct NSObject { Class x1; }*)arg1;
- (void)setInflightImagePath:(id)arg1;
- (void)setInflightIndexSheetImage:(struct NSObject { Class x1; }*)arg1;
- (void)setInflightMetadata:(id)arg1;
- (void)setIsInFlight:(bool)arg1;
- (void)setKeywordBadgeAttribute:(unsigned int)arg1;
...
- (void)setRAWPlusJPEGBadgeAttribute:(unsigned int)arg1;
