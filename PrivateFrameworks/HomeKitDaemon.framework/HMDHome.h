...
@interface HMDHome : HMFObject <HMDAccessoryBrowserDelegate, HMDBackingStoreObjectProtocol, HMDBulletinIdentifiers, HMDHomeMessageReceiver, HMDMediaActionRouterDataSource, HMDRelayManagerDelegate, HMDResidentDeviceManagerDelegate, HMDUserManagementOperationDelegate, HMFDumpState, HMFLogging, HMFTimerDelegate, NSSecureCoding> {
...
- (void)_processAccessoriesToAddForUnpairedAccessory:(id)arg1 certificationStatus:(long long)arg2 accessoryServer:(id)arg3 networkCredential:(id)arg4 message:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)accessoryBrowser:(id)arg1 setupID:(id)arg2 serverIdentifier:(id)arg3 isPairedWithCompletionHandler:(id /* block */)arg4;
...
- (bool)isCarPlayAllowedActionOnService:(id)arg1;
