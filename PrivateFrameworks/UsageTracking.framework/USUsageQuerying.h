...
@interface USUsageQuerying : NSObject {
    ...
    <_DKKnowledgeQuerying> * _eventStorage;
}

@property (readonly) <_CDUserContext> *context;
@property (readonly) <_DKKnowledgeQuerying> *eventStorage;
...
- (void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(id /* block */)arg3;
- (void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(id /* block */)arg3;
