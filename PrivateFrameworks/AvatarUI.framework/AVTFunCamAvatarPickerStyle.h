...
- (id)initWithCellSize:(struct CGSize { double x1; double x2; })arg1 engagedCellSize:(struct CGSize { double x1; double x2; })arg2 interitemSpacing:(double)arg3 gridEdgeInsets:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg4 centerVertically:(bool)arg5;
