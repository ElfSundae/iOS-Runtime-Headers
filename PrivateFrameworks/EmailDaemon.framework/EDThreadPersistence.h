...
- (void)_iterateWrappedMessagesByConversationForPersistedMessages:(id)arg1 writeBlock:(id /* block */)arg2;
...
- (void)threadScopeManager:(id)arg1 gatherStatisticsForThreadScopes:(id)arg2 block:(id /* block */)arg3;
...
- (id /* block */)threadScopeMatcherForActivatedAccount:(id)arg1;
