...
@interface MFMessageContentView : UIView <EFSignpostable, MFBlockedSenderBannerViewDelegate, MFHasMoreContentBannerViewDelegate, MFLoadBlockedContentBannerViewDelegate, MFMailDropBannerDelegate, MFMailWebProcessDelegate, MFMessageFooterViewDelegate, MFMessageHeaderViewDelegate, MFReusable, UIPopoverPresentationControllerDelegate, UIScrollViewDelegate, WKNavigationDelegate, WKNavigationDelegatePrivate, WKUIDelegatePrivate> {
...
- (void)setResizingWrapperView:(id)arg1;
