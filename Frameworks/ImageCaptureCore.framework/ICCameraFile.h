...
@property (nonatomic, copy) NSString *devMediaBase;
...
@property (nonatomic) bool imgHasMetadata;
@property (nonatomic) bool imgHasThumbnail;
@property (nonatomic) unsigned long long imgOrientation;
@property (nonatomic, copy) NSString *imgSpatialOverCaptureGroupID;
...
- (id)imgSpatialOverCaptureGroupID;
