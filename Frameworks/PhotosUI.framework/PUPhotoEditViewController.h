...
@property (nonatomic, retain) PUTimeInterval *enterEditTimeInterval;
@property (nonatomic, retain) PUExitEditPerformanceEventBuilder *exitEditEventBuilder;
@property (nonatomic, retain) PUTimeInterval *exitEditTimeInterval;
...
@property (nonatomic, retain) PUTimeInterval *resourceCheckingInterval;
@property (nonatomic, retain) PUTimeInterval *resourceDownloadInterval;
@property (nonatomic, retain) PUTimeInterval *resourceLoadingInterval;
