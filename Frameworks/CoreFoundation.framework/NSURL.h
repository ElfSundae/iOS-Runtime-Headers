...
@property (nonatomic, readonly) bool hu_isHomeKnowledgeBasedArticleURL;
...
@property (nonatomic, readonly) bool ic_isExcludedFromNonCloudBackups;
...
- (bool)ic_isExcludedFromNonCloudBackups;
- (bool)ic_isMapURL;
- (bool)ic_isNewsURL;
- (bool)ic_isReachable;
