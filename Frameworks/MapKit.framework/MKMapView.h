...
@property (getter=_isGeodHealthConsoleEnabled, setter=_setGeodHealthConsoleEnabled:, nonatomic) bool geodHealthConsoleEnabled;
...
@property (getter=_loadMuninAvailability, setter=_setLoadMuninAvailability:, nonatomic) bool loadMuninAvailability;
...
- (id)_initWithFrame:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg1 gestureRecognizerHostView:(id)arg2 showsAttribution:(bool)arg3 showsAppleLogo:(bool)arg4;
