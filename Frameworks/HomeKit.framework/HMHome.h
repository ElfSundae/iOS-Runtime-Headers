...
@interface HMHome : NSObject <HFCharacteristicValueReader, HFCharacteristicValueWriter, HFReorderableHomeKitObject, HFStateDumpBuildable, HFWallaperHost, HMFLogging, HMFMessageReceiver, HMMutableApplicationData, HMObjectMerge, NSSecureCoding> {
    bool  _adminUser;
...
- (void)_enableMultiUserWithCompletionHandler:(id /* block */)arg1;
